...
import type { RelativePosixFilePath } from '@shipixen/utils'
...
export const DocumentContext = tag<DocumentContext>(Symbol.for('@shipixen/source-files/DocumentContext'))
