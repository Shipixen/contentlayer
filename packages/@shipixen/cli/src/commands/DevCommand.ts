...
import { E, OT, pipe, S, T } from '@shipixen/utils/effect'
...
export class DevCommand extends BaseCommand {
  ...
  executeSafe = () =>
    pipe(
      ...
      OT.withStreamSpan('@shipixen/cli/commands/DevCommand:stream'),
      S.runDrain,
      OT.withSpan('@shipixen/cli/commands/DevCommand:executeSafe'),
    )
}
