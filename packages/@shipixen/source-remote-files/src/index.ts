...
import type { Args as SourceFilesArgs } from '@shipixen/source-files'
import { makeSource as makeSourceFromSourceFiles } from '@shipixen/source-files'
import { unknownToAbsolutePosixFilePath } from '@shipixen/utils'
import { M, OT, pipe, S, T } from '@shipixen/utils/effect'
