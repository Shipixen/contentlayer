...
import { fs } from '@shipixen/utils'
import type { HasConsole } from '@shipixen/utils/effect'
import { Chunk, OT, pipe, T } from '@shipixen/utils/effect'
...
export const fetchAllDocuments = ({
  ...
  pipe(
    T.gen(function* ($) {
      ...
      const documents = yield* $(
        pipe(
          ...
          OT.withSpan('@shipixen/source-contentlayer/fetchData:makeCacheItems', {
    ...
    OT.withSpan('@shipixen/source-contentlayer/fetchData:fetchAllDocuments', {
...
const getAllEntries = (
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/fetchData:getAllEntries'),
  )
...
const getAllAssets = (
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/fetchData:getAllAssets'),
  )
