...
import { SourceProvideSchemaError } from '@shipixen/core'
import * as utils from '@shipixen/utils'
import { casesHandled, partition } from '@shipixen/utils'
...
export const provideSchema = ({
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/fetchData:provideSchema', {
