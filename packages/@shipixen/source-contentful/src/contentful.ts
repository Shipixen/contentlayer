import { OT, pipe, T } from '@shipixen/utils/effect'
...
export const environmentGetContentTypes = (
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/contentful:environmentGetContentTypes'),
  )
...
export const environmentGetEntries = ({
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/contentful:environmentGetEntries'),
  )
...
export const environmentGetAssets = ({
  ...
  pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/contentful:environmentGetAssets'),
  )
...
export const getEnvironment = ({
  ...
  return pipe(
    ...
    OT.withSpan('@shipixen/source-contentlayer/contentful:getEnvironment'),
